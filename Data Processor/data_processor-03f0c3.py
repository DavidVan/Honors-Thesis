...
if __name__ == '__main__':
    ...
    for results_dir_name, features_wanted in features_to_test.items():
        ...
        for classifier_name, clf in clfs.items():
            ...
            #     features_list_no_label = ['ip_src_length', 'ip_src_subdomain_length', 'ip_dest_length', 'ip_dest_subdomain_length', 'src_ip_freq', 'dest_ip_freq', 'ssl']
            #     features_list = ['ip_src_length', 'ip_src_subdomain_length', 'ip_dest_length', 'ip_dest_subdomain_length', 'ssl', 'src_ip_freq', 'dest_ip_freq', 'label']
